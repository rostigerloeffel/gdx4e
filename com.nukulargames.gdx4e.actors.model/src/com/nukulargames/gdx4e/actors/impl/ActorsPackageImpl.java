 ...
 * @generated
 */
public class ActorsPackageImpl extends EPackageImpl implements ActorsPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see com.nukulargames.gdx4e.actors.ActorsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private ActorsPackageImpl() {
		super(eNS_URI, ActorsFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link ActorsPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static ActorsPackage init() {
		if (isInited) return (ActorsPackage)EPackage.Registry.INSTANCE.getEPackage(ActorsPackage.eNS_URI);

		// Obtain or create and register package
		ActorsPackageImpl theActorsPackage = (ActorsPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof ActorsPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new ActorsPackageImpl());

		isInited = true;

		// Create package meta-data objects
		theActorsPackage.createPackageContents();

		// Initialize created meta-data
		theActorsPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theActorsPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(ActorsPackage.eNS_URI, theActorsPackage);
		return theActorsPackage;
	}
	 ...
	 * @generated
	 */
	public EAttribute getAnimation_Texture() {
	 ...
	 * @generated
	 */
	public EAttribute getAnimation_Columns() {
	 ...
	 * @generated
	 */
	public EAttribute getAnimation_Rows() {
	 ...
	 * @generated
	 */
	public EAttribute getAnimation_Delay() {
	 ...
	 * @generated
	 */
	public EReference getState_Animation() {
	...
	public void createPackageContents() {
		...
		createEAttribute(actorEClass, ACTOR__SCALE_Y);
		createEAttribute(actorEClass, ACTOR__ROTATION);
		createEReference(actorEClass, ACTOR__ANIMATIONS);
		...
		createEAttribute(animationEClass, ANIMATION__TEXTURE);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getActor_Width(), ecorePackage.getEFloat(), "width", null, 0, 1, Actor.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getActor_Height(), ecorePackage.getEFloat(), "height", null, 0, 1, Actor.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getActor_ScaleY(), ecorePackage.getEFloat(), "scaleY", "1.0f", 0, 1, Actor.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getActor_Rotation(), ecorePackage.getEFloat(), "rotation", null, 0, 1, Actor.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getActor_Animations(), this.getAnimation(), null, "animations", null, 0, -1, Actor.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getAnimation_Texture(), ecorePackage.getEString(), "texture", null, 0, 1, Animation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
