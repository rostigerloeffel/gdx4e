...
public class DslSyntacticSequencer extends AbstractSyntacticSequencer {
	 ...
	 *     name=QualifiedName (ambiguity) (rule end)
	 */
	protected void emit_Animation_ColonKeyword_3_0_q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
	 ...
	 *     name=QualifiedName (ambiguity) (rule end)
	 */
	protected void emit_State_ColonKeyword_3_0_q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
