	...
	(
		...
		(
			...
			(
				(
					{
						newCompositeNode(grammarAccess.getActor_ImplAccess().getAnimationsAnimationParserRuleCall_3_9_0());
					}
					lv_animations_28_0=ruleAnimation
					{
						if ($current==null) {
							$current = createModelElementForParent(grammarAccess.getActor_ImplRule());
						}
			...
			(
				(
					{
						newCompositeNode(grammarAccess.getActor_ImplAccess().getStatesStateParserRuleCall_3_10_0());
					}
		...
		(
			otherlv_30='default'
			{
				newLeafNode(otherlv_30, grammarAccess.getActor_ImplAccess().getDefaultKeyword_4_0());
			}
			otherlv_31='='
			{
				newLeafNode(otherlv_31, grammarAccess.getActor_ImplAccess().getEqualsSignKeyword_4_1());
			}
			(
				(
					{
					...
					otherlv_32=RULE_ID
					{
						newLeafNode(otherlv_32, grammarAccess.getActor_ImplAccess().getDefaultStateStateCrossReference_4_2_0());
					}
				)
			)
		)?
