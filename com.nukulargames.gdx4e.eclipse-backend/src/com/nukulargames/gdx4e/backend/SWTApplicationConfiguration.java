...
import com.nukulargames.gdx4e.backend.Lwjgl3Graphics.Lwjgl3DisplayMode;
import com.nukulargames.gdx4e.backend.Lwjgl3Graphics.Lwjgl3Monitor;

public class SWTApplicationConfiguration {
	...
	String title = "";
	Color initialBackgroundColor = Color.RED;
	...
	static SWTApplicationConfiguration copy(SWTApplicationConfiguration config) {
		SWTApplicationConfiguration copy = new SWTApplicationConfiguration();
