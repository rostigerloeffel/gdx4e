	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getActorReferenceAccess().getAlternatives_1(), "rule__ActorReference__Alternatives_1");
					...
					put(grammarAccess.getActorAccess().getGroup_3_1_0(), "rule__Actor__Group_3_1_0__0");
					put(grammarAccess.getActorAccess().getGroup_3_1_1(), "rule__Actor__Group_3_1_1__0");
					put(grammarAccess.getActorAccess().getGroup_3_1_2(), "rule__Actor__Group_3_1_2__0");
					put(grammarAccess.getActorAccess().getGroup_3_1_3(), "rule__Actor__Group_3_1_3__0");
					put(grammarAccess.getActorAccess().getGroup_3_1_4(), "rule__Actor__Group_3_1_4__0");
					put(grammarAccess.getActorAccess().getGroup_3_1_5(), "rule__Actor__Group_3_1_5__0");
					put(grammarAccess.getActorAccess().getGroup_3_1_6(), "rule__Actor__Group_3_1_6__0");
					put(grammarAccess.getActorAccess().getGroup_3_1_7(), "rule__Actor__Group_3_1_7__0");
					put(grammarAccess.getActorAccess().getGroup_3_1_8(), "rule__Actor__Group_3_1_8__0");
					put(grammarAccess.getActorAccess().getGroup_3_1_9(), "rule__Actor__Group_3_1_9__0");
					put(grammarAccess.getActorAccess().getGroup_3_1_10(), "rule__Actor__Group_3_1_10__0");
					put(grammarAccess.getActorAccess().getGroup_3_1_14(), "rule__Actor__Group_3_1_14__0");
					...
					put(grammarAccess.getAnimationAccess().getGroup_3_1_0(), "rule__Animation__Group_3_1_0__0");
					put(grammarAccess.getAnimationAccess().getGroup_3_1_1(), "rule__Animation__Group_3_1_1__0");
					put(grammarAccess.getAnimationAccess().getGroup_3_1_2(), "rule__Animation__Group_3_1_2__0");
					put(grammarAccess.getAnimationAccess().getGroup_3_1_3(), "rule__Animation__Group_3_1_3__0");
					...
					put(grammarAccess.getActorReferenceAccess().getGroup_1_0(), "rule__ActorReference__Group_1_0__0");
					put(grammarAccess.getActorReferenceAccess().getGroup_1_1(), "rule__ActorReference__Group_1_1__0");
					put(grammarAccess.getActorReferenceAccess().getGroup_2(), "rule__ActorReference__Group_2__0");
					put(grammarAccess.getActorReferenceAccess().getGroup_2_0(), "rule__ActorReference__Group_2_0__0");
					put(grammarAccess.getStageAccess().getGroup(), "rule__Stage__Group__0");
					put(grammarAccess.getStageAccess().getGroup_3(), "rule__Stage__Group_3__0");
					...
					put(grammarAccess.getModelAccess().getActorsAssignment_2_0(), "rule__Model__ActorsAssignment_2_0");
					put(grammarAccess.getModelAccess().getStagesAssignment_2_1(), "rule__Model__StagesAssignment_2_1");
					put(grammarAccess.getActorAccess().getNameAssignment_2(), "rule__Actor__NameAssignment_2");
					put(grammarAccess.getActorAccess().getXAssignment_3_1_0_2(), "rule__Actor__XAssignment_3_1_0_2");
					put(grammarAccess.getActorAccess().getYAssignment_3_1_1_2(), "rule__Actor__YAssignment_3_1_1_2");
					put(grammarAccess.getActorAccess().getWidthAssignment_3_1_2_2(), "rule__Actor__WidthAssignment_3_1_2_2");
					put(grammarAccess.getActorAccess().getHeightAssignment_3_1_3_2(), "rule__Actor__HeightAssignment_3_1_3_2");
					put(grammarAccess.getActorAccess().getScaleXAssignment_3_1_4_2(), "rule__Actor__ScaleXAssignment_3_1_4_2");
					put(grammarAccess.getActorAccess().getScaleYAssignment_3_1_5_2(), "rule__Actor__ScaleYAssignment_3_1_5_2");
					put(grammarAccess.getActorAccess().getRotationAssignment_3_1_6_2(), "rule__Actor__RotationAssignment_3_1_6_2");
					put(grammarAccess.getActorAccess().getRedAssignment_3_1_7_2(), "rule__Actor__RedAssignment_3_1_7_2");
					put(grammarAccess.getActorAccess().getGreenAssignment_3_1_8_2(), "rule__Actor__GreenAssignment_3_1_8_2");
					put(grammarAccess.getActorAccess().getBlueAssignment_3_1_9_2(), "rule__Actor__BlueAssignment_3_1_9_2");
					put(grammarAccess.getActorAccess().getAlphaAssignment_3_1_10_2(), "rule__Actor__AlphaAssignment_3_1_10_2");
					put(grammarAccess.getActorAccess().getAnimationsAssignment_3_1_11(), "rule__Actor__AnimationsAssignment_3_1_11");
					put(grammarAccess.getActorAccess().getStatesAssignment_3_1_12(), "rule__Actor__StatesAssignment_3_1_12");
					put(grammarAccess.getActorAccess().getChildrenAssignment_3_1_13(), "rule__Actor__ChildrenAssignment_3_1_13");
					put(grammarAccess.getActorAccess().getDefaultStateAssignment_3_1_14_2(), "rule__Actor__DefaultStateAssignment_3_1_14_2");
					put(grammarAccess.getAnimationAccess().getNameAssignment_2(), "rule__Animation__NameAssignment_2");
					put(grammarAccess.getAnimationAccess().getTextureAssignment_3_1_0_2(), "rule__Animation__TextureAssignment_3_1_0_2");
					put(grammarAccess.getAnimationAccess().getColumnsAssignment_3_1_1_2(), "rule__Animation__ColumnsAssignment_3_1_1_2");
					put(grammarAccess.getAnimationAccess().getRowsAssignment_3_1_2_2(), "rule__Animation__RowsAssignment_3_1_2_2");
					put(grammarAccess.getAnimationAccess().getDelayAssignment_3_1_3_2(), "rule__Animation__DelayAssignment_3_1_3_2");
					...
					put(grammarAccess.getActorReferenceAccess().getHoldsAssignment_1_0_1(), "rule__ActorReference__HoldsAssignment_1_0_1");
					put(grammarAccess.getActorReferenceAccess().getUsesAssignment_1_1_1(), "rule__ActorReference__UsesAssignment_1_1_1");
					put(grammarAccess.getActorReferenceAccess().getQuantityAssignment_2_0_2(), "rule__ActorReference__QuantityAssignment_2_0_2");
					put(grammarAccess.getStageAccess().getNameAssignment_2(), "rule__Stage__NameAssignment_2");
					put(grammarAccess.getStageAccess().getActorsAssignment_3_1(), "rule__Stage__ActorsAssignment_3_1");
					...
					put(grammarAccess.getActorAccess().getUnorderedGroup_3_1(), "rule__Actor__UnorderedGroup_3_1");
					put(grammarAccess.getAnimationAccess().getUnorderedGroup_3_1(), "rule__Animation__UnorderedGroup_3_1");
				}
			};
		}
