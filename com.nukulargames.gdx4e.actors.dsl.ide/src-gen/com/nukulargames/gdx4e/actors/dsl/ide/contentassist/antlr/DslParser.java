		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getActor_ImplAccess().getAnimationsAssignment_3_9(), "rule__Actor_Impl__AnimationsAssignment_3_9");
					put(grammarAccess.getActor_ImplAccess().getStatesAssignment_3_10(), "rule__Actor_Impl__StatesAssignment_3_10");
