...
/**
 * This is the item provider adapter for a {@link com.nukulargames.gdx4e.actors.Model} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModelItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Model_actors_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Model_actors_feature", "_UI_Model_type"),
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ActorsPackage.Literals.MODEL__BASE_PACKAGE,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ActorsPackage.Literals.MODEL__LAYERS);
		}
	...
	public String getText(Object object) {
		String label = ((Model)object).getBasePackage();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Model.class)) {
			...
			case ActorsPackage.MODEL__LAYERS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ActorsPackage.Literals.MODEL__ACTORS,
				 ActorsFactory.eINSTANCE.createGroup()));

		newChildDescriptors.add
			(createChildParameter
				(ActorsPackage.Literals.MODEL__LAYERS,
				 ActorsFactory.eINSTANCE.createLayer()));
	}
