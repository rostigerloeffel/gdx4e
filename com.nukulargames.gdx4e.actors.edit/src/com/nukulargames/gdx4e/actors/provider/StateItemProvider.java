...
/**
 * This is the item provider adapter for a {@link com.nukulargames.gdx4e.actors.State} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ActorsPackage.Literals.STATE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addAnimationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_State_animation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_State_animation_feature", "_UI_State_type"),
				 ActorsPackage.Literals.STATE__ANIMATION,
				 true,
				 false,
				 true,
				 null,
