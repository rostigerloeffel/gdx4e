...
/**
 * This is the item provider adapter for a {@link com.nukulargames.gdx4e.actors.Animation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AnimationItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Animation_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Animation_name_feature", "_UI_Animation_type"),
				 ActorsPackage.Literals.ANIMATION__NAME,
				 true,
				 false,
				 false,
	...
	protected void addTexturePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Animation_texture_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Animation_texture_feature", "_UI_Animation_type"),
				 ActorsPackage.Literals.ANIMATION__TEXTURE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addColumnsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Animation_columns_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Animation_columns_feature", "_UI_Animation_type"),
				 ActorsPackage.Literals.ANIMATION__COLUMNS,
				 true,
				 false,
				 false,
	...
	protected void addRowsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Animation_rows_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Animation_rows_feature", "_UI_Animation_type"),
				 ActorsPackage.Literals.ANIMATION__ROWS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	protected void addDelayPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Animation_delay_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Animation_delay_feature", "_UI_Animation_type"),
				 ActorsPackage.Literals.ANIMATION__DELAY,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Animation)object).getName();
